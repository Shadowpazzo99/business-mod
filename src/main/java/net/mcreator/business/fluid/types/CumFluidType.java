...
package net.mcreator.business.fluid.types;
...
public class CumFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("business:blocks/cum"),
					FLOWING_TEXTURE = new ResourceLocation("business:blocks/cum");
